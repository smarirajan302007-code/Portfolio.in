...
const PasswordInput = ({ name, label, showKey, form, show, setShow, handleChange }) => (
  <div>
    ...
    <div className="max-w-md space-y-6">
      ...
      <div className="glass-card p-10">
        <form onSubmit={handleSubmit} className="space-y-4">
          <PasswordInput name="currentPassword" label="Current Password" showKey="current" form={form} show={show} setShow={setShow} handleChange={handleChange} />
          <PasswordInput name="newPassword" label="New Password" showKey="new" form={form} show={show} setShow={setShow} handleChange={handleChange} />
          <PasswordInput name="confirmPassword" label="Confirm New Password" showKey="confirm" form={form} show={show} setShow={setShow} handleChange={handleChange} />
