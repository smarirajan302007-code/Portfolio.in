        ...
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-4 flex-shrink-0 pl-2">
            ...
            <div className="relative group/lock flex items-center">
              <Link to={admin ? "/admin/dashboard" : "/admin/login"} className="text-dark-500 hover:text-green-400 transition-colors relative" title={admin ? "Admin Dashboard" : "Admin Login"}>
                <FaLock size={14} />
                {unreadCount > 0 && (
